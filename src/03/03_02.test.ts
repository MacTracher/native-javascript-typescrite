import {changeBudget, CityType, CreateGreationgMessage, repairHouse, toFireStaff, toHireStaff} from "./03_02";
...
test('Check greeting message on mistake', () => {
    const message = CreateGreationgMessage(city);

    expect(message).toBe('Hello New York, I hope you happy!!')
})
